...
#ifndef MOENGAGE_FLUTTER_IOS_SWIFT_H
#define MOENGAGE_FLUTTER_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="moengage_flutter_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20moengage_flutter_ios21MoEngageFlutterBridge")
...
@interface MoEngageFlutterBridge (SWIFT_EXTENSION(moengage_flutter_ios)) <MoEngagePluginBridgeDelegate>
