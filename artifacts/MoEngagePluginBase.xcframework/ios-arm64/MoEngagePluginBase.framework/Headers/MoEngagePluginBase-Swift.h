...
#ifndef MOENGAGEPLUGINBASE_SWIFT_H
#define MOENGAGEPLUGINBASE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoEngagePluginBase",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)initializeInstanceWithSdkConfig:(MoEngageSDKConfig * _Nonnull)sdkConfig launchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions;
- (void)trackPluginInfo:(NSString * _Nonnull)pluginType version:(NSString * _Nonnull)version;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol MoEngagePluginBridgeDelegate;
SWIFT_CLASS("_TtC18MoEngagePluginBase20MoEngagePluginBridge") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface MoEngagePluginBridge : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MoEngagePluginBridge * _Nonnull sharedInstance;)
+ (MoEngagePluginBridge * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)pluginInitialized:(NSDictionary<NSString *, id> * _Nonnull)accountInfo;
- (void)setPluginBridgeDelegate:(id <MoEngagePluginBridgeDelegate> _Nonnull)delegate identifier:(NSString * _Nonnull)identifier;
- (void)setPluginBridgeDelegate:(id <MoEngagePluginBridgeDelegate> _Nonnull)delegate payload:(NSDictionary<NSString *, id> * _Nonnull)payload;
- (void)updateSDKState:(NSDictionary<NSString *, id> * _Nonnull)sdkState;
- (void)optOutDataTracking:(NSDictionary<NSString *, id> * _Nonnull)dataTrack;
- (void)identifyUser:(NSDictionary<NSString *, id> * _Nonnull)identities;
- (void)getUserIdentities:(NSDictionary<NSString *, id> * _Nonnull)payload completionHandler:(void (^ _Nonnull)(NSDictionary<NSString *, NSString *> * _Nonnull))completionHandler;
- (void)setAppStatus:(NSDictionary<NSString *, id> * _Nonnull)appStatus;
- (void)setAlias:(NSDictionary<NSString *, id> * _Nonnull)alias;
- (void)setUserAttribute:(NSDictionary<NSString *, id> * _Nonnull)userAttribute;
...
- (void)getSelfHandledInApps:(NSDictionary<NSString *, id> * _Nonnull)payload completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nonnull))completionBlock;
...
- (void)updateSelfHandledImpression:(NSDictionary<NSString *, id> * _Nonnull)inApp;
- (void)registerForPush;
- (void)registerForProvisionalPush SWIFT_AVAILABILITY(ios,introduced=12.0);
- (BOOL)validateSDKVersion SWIFT_WARN_UNUSED_RESULT;
@end
