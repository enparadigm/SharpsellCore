...
#ifndef MOENGAGE_FLUTTER_SWIFT_H
#define MOENGAGE_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="moengage_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16moengage_flutter21MoEngageFlutterBridge")
@interface MoEngageFlutterBridge : NSObject <FlutterPlugin>
...
@interface MoEngageFlutterBridge (SWIFT_EXTENSION(moengage_flutter)) <MoEngagePluginBridgeDelegate>
...
SWIFT_CLASS("_TtC16moengage_flutter19MoEngageInitializer")
@interface MoEngageInitializer : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) MoEngageInitializer * _Nonnull sharedInstance;)
+ (MoEngageInitializer * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
